...
class Properties {
  static data = [
    ...
    { id: 21, name: "world", location: "Irvine", pcoe: "2023-02-02", sale: 12500.99, rating: 2, comments: "short text" },
...
class All {
  constructor() {
    this.all = new DataGrid("grid_all", {
      ...
      columns: [
        ...
        { field: "pcoe", type: "date", headerFilterEmpty: true, formatter: "date", formatterParams: { dateField: "pcoe", format: "MM/dd/yyyy"} },
        { 
          field: "location", 
          filterType: "equals", 
  ...
  async render() {
    this.all.addColumn({ field: "rating", type: "number", formatter: "star" });
    await this.all.init();
  }
}
